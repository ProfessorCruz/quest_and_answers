    ...
    for event in pygame.event.get():
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_q:
                num = randint(1,3)
                if num == 1:
                    quest_card.set_text('O que você estuda na Algorithmics?', 25)
                if num == 2:
                    quest_card.set_text('Qual a língua falada na França?', 25)
                if num == 3:
                    quest_card.set_text('O que cresce na Macieira?', 35)
            ...
            if event.key == pygame.K_a:
                ...
                if num == 2:
                    ans_card.set_text('Francês', 35)
                if num == 3:
                    ans_card.set_text('Maçãs', 35)
                ans_card.draw(10, 25)
    clock.tick(40)     